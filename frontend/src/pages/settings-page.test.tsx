...
it("groups appearance, AI, data, and About settings with an explicit Theme label", async () => {
  ...
  expect(await screen.findByText("Connected · API key stored locally")).toBeInTheDocument()
  expect(screen.getByText("Connected · fair-access identity stored locally")).toBeInTheDocument()
