...
export function SettingsPage() {
  ...
  return <div className="max-w-3xl space-y-6"><header><h1 className="text-3xl font-semibold tracking-tight">Settings</h1><p className="mt-1 text-sm text-muted-foreground">Configure data sources, AI providers, and application preferences.</p></header>
    ...
    <Section title="About"><div className="space-y-3 text-sm text-muted-foreground"><ReasonframeLockup className="text-xl text-foreground"/><div><p className="font-medium text-foreground">Financial research with specialist AI analysts.</p><p className="mt-1 text-xs">Version 0.1.0-rc.2</p></div><p>Reasonframe combines company fundamentals, market data, macroeconomic context, valuation, and structured AI analysis in a local-first desktop application.</p><p>Data comes from SEC filings, FRED, and locally stored Tiingo market data. AI analysis is backed by inspectable evidence. Reasonframe does not provide investment advice.</p></div></Section>
  </div>
}
